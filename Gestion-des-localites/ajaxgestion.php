...
if (isset($_POST["code"])) {
    ...
    $sql = "SELECT * FROM FICHE_COMM_LOCALITE INNER JOIN LOCALITE ON (FICHE_COMM_LOCALITE.Id_loc=LOCALITE.idlocalite) WHERE FICHE_COMM_LOCALITE.idfiche_commune='" . $_POST['code']."' ORDER BY Id_loc";
    ...
    $req_loc=" SELECT COUNT(*) AS loc_size FROM FICHE_COMM_LOCALITE WHERE idfiche_commune='" . $_POST['code']. "'";
